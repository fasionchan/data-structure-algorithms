...
html_theme_options = {
    'logo': 'logo.jpg',
    #'logo_name': True,
    'description': u'本专栏收录常用数据结构及算法，附以详细讲解和代码示例。',
    ...
    'github_repo': 'data-structure-algorithms',
    'github_banner': True,
    'github_type': 'star',
...
latex_documents = [
    (master_doc, 'DSA.tex', u'DSA Documentation',
     author, 'manual'),
]
...
man_pages = [
    (master_doc, 'dsa', u'DSA Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'DSA', u'DSA Documentation',
     author, 'DSA', 'One line description of project.',
     'Miscellaneous'),
]
